...
namespace BarCodeAPIService.Service
{
    public class TokenService : ITokenService
    {
        ...
        {
            connectionStringSAP.ConnectionString = configuration.GetSection("ConnectionStringSAP").Value.ToString();
            connectionString.ConnectionString = configuration.GetSection("ConnectionString").Value.ToString();
            ...
            try
            {
                ...
                if (1==1)
                {
                    ...
                    else
                    {
                        ...
                        sqlCommand.Connection = connectionString;
                        sqlCommand.CommandType = CommandType.Text;
                        sqlCommand.CommandText = "INSERT INTO Tb_Token(CardCode,Token,active,CreateDate,[Update],ExpireDate) " +
        ...
        public Task<RefreshResponse> RefrestAsync(RefreshRequest refreshRequest)
        {
            ...
            if (dataTable.Rows.Count > 0)
            {
                ...
                else
                {
                    ...
                    sqlCommand.Connection = connectionString;
                    sqlCommand.CommandType = CommandType.Text;
                    sqlCommand.CommandText = "UPDATE Tb_Token SET Token=@token,CreateDate=@createDate,ExpireDate=@expireDate Where CardCode=@cardCode";
                    sqlCommand.Parameters.AddWithValue("@token", a.Token);
                    sqlCommand.Parameters.AddWithValue("@createDate", Convert.ToDateTime(a.ValidFrom).ToLocalTime());
                    sqlCommand.Parameters.AddWithValue("@expireDate", Convert.ToDateTime(a.ValidTo).ToLocalTime());
                    sqlCommand.Parameters.AddWithValue("@cardCode", refreshRequest.CardCode);
